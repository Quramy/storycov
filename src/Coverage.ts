...
class JSCoverage {
  ...
  async _onScriptParsed(event: Protocol.Debugger.ScriptParsedEvent): Promise<void> {
  ...
  async stop(): Promise<JSCoverageEntry[]> {
    ...
    const result = await Promise.all<Protocol.Profiler.TakePreciseCoverageResponse, void, void, void>([
      // @ts-ignore
